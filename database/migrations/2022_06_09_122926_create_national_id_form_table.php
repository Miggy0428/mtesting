...
class CreateNationalIdFormTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('national_id_form', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('GSIS_SSS')->nullable();
    ...
    {
        Schema::dropIfExists('national_id_form');
    }
}
